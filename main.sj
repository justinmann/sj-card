...
for i : 0 to total {
    ...
    render(h : 'hyperscript, model : 'jsonValue) {
...
for i : 0 to total {
    ...
    render3(h : 'hyperscript, model : 'jsonValue2) {
        h.tag("Section", [ ("id" , "titleSection"), ("spacing" , "none") ], ^{
            _.tag("Heading", [ ("id" , "title"), ("headingLevel" , "1"), ("textSize" , "large"), ("spacing" , "none"), ("textColor" , "secondary") ], ^{
                // _.tag("Text", { "id" : "productTitle", "textSize" : "large"}).join(" ", function (h) {
                //     _.raw(model.title)
...
end4 : clock()
debug.writeLine("msec: " + ((end4 - start4) as f64 * 1000.0 / clocks_per_sec as f64).asString())